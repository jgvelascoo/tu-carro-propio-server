...
export const getPosts = async (req, res) => {
  ...
  const SORT_CASES = {
    'reciente': '-createdAt -km',
    'descendente': '-price -km',
    'ascendente': 'price -km'
  }
...
export const updatePost = async (req, res) => {
  ...
  const { brand, model, version, type, year, km, price, transmission, fuel, t4x4, armor,
    motor, owners, tapizado, location, power, accel, fuelConsumption, fuelCapacity, details,
    folder, mainImgN, othersImgN, mainImgD, othersImgD, mainImg, othersImg} = req.body;

  //console.log(req.body)
  //console.log('mainImgN' in req.body | 'othersImgN' in req.body)
